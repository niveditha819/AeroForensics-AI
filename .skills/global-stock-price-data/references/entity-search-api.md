...
**Endpoint:** `GET https://app-cikf8p3h6lmp-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-cikf8p3h6lmp-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
