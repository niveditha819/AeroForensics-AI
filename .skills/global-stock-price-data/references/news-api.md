...
**Endpoint:** `GET https://app-cikf8p3h6lmp-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-cikf8p3h6lmp-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
