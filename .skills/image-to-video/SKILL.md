...
| Item | Details |
|------|---------|
| Submit endpoint | `POST https://app-cikf8p3h6lmp-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video` |
| Query endpoint | `GET https://app-cikf8p3h6lmp-api-oYA6Z8wDBRDa.gateway.appmedo.com/v1/videos/image2video/{id}` |
