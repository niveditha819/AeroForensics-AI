...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-cikf8p3h6lmp-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| Query Endpoint | `GET https://app-cikf8p3h6lmp-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}` |
